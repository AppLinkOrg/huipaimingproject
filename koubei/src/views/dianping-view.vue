...
<template>
  <div>
    ...
    <div v-if="resource != null && inst != null" class="text-center margin-top-49">
      <van-dialog v-model:show="show" title="" confirm-button-text="更换下一组" theme="round-button" @confirm="randomChange">
        <div class="text-center margin-top-49"><img class="success" :src="uploadpath + 'resource/' + resource.success" /></div>
