      ...
      <div v-if="resource != null && inst != null">
        <div class="bg-gray min-wh100">
          <div class="pk">
                  ...
                  <div class="flex-row flex-center memberinfo">
                    ...
                    <div class="flex-1 margin-left-15 margin-right-15">
                      <div class="flex-row flex-center">
                        ...
                        <img
                          @click="showInfo = true"
                          class="margin-left-15 wh-20"
                          :src="uploadpath + 'resource/' + resource.info2"
                        />
                      </div>
                      <div class="flex-row margin-top-11">
                        <div
                          class="databox fc-white fw-400 f-13 flex-row flex-center margin-right-15"
                        >
                          积分: {{ member.jifen }}
                        </div>
            ...
            <div class="flex-row flex-center">
              <div
                class="flex-1 text-center f-18 fw-cold fc-black tabitem"
                @click="isdianping = true"
              >
                <div>点评记录</div>
